...
最新版本 **0.5.8**（2026-09-16） · 开发中 **9** 项改动尚未发布 · [完整更新日志](CHANGELOG.md)

<details open>
<summary><b>2026-09-17</b> · 未发布 · 新增 1 · 样式 2 · 修复 4</summary>
...
- 刘海岛展开面板底栏的「N 个未能更新」点了没有反应，也看不出是哪些服务商、为什么没更新；点刷新按钮时读取很快就返回，转圈一闪而过，看起来像没点到。现在把鼠标移到这行字上或点一下，上方会列出每个未能更新的服务商：图标、名称和上次刷新的出错原因，还显示着旧读数的会注明数据是多久前的；点其中一个直接打开设置 → 服务商里它的那一行。点刷新后转圈至少持续 0.8 秒，结束后这行字显示约 2 秒「已全部更新」或「已刷新 · N 个未能更新」。
