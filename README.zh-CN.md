...
最新版本 **0.5.12**（2026-09-22） · 开发中 **2** 项改动尚未发布 · [完整更新日志](CHANGELOG.md)

<details open>
<summary><b>2026-09-22</b> · 未发布 · 修复 2</summary>
...
- 0.5.12 起菜单栏显示哪个额度要单独选，但入口只在设置里，在菜单栏自己的右键菜单里找不到。现在右键菜单栏图标，「显示在菜单栏」下面多了一项「Cursor 显示的额度」（名字跟着当前选中的服务商变），可以直接选套餐里的某个额度或「自动」。
...
<details>
<summary><b>2026-09-21</b> · 0.5.11 · 修复 5</summary>
